...
function App() {
  ...
  const [startDate, setStartDate] = useState('2024-09-29T09:46:32');
  const [endDate, setEndDate] = useState('2024-10-01T00:00:00');
  ...
  useEffect(() => {
    ...
    fetch('/transactions refreshed 10-1.csv')
                ...
                <Box p={4} borderWidth={1} borderRadius="lg" bg="white">
                  <Flex justify="space-between" align="center" mb={2}>
                    ...
                    <Text fontSize="sm" color="gray.500" fontStyle="italic" flex={1} textAlign="right">
                      last refreshed October 1st 12:00:00 AM
                    </Text>
                  </Flex>
                  <Box height="400px">
