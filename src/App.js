...
function App() {
  ...
  const [startDate, setStartDate] = useState('2024-10-30T09:46:32');
  const [endDate, setEndDate] = useState('2024-11-01T00:00:00');
  ...
  useEffect(() => {
    ...
    fetch('/transactions refreshed 11-1.csv')
                ...
                <Box p={4} borderWidth={1} borderRadius="lg" bg="white">
                  <Flex justify="space-between" align="center" mb={2}>
                    ...
                    <Text fontSize="sm" color="gray.500" fontStyle="italic" flex={1} textAlign="right">
                      last refreshed November 1st 12:00:00 AM
                    </Text>
                  </Flex>
                  <Box height="400px">
